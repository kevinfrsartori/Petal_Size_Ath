...
#traits
filename<-grep("SNP_1001g_filtered_",list.files("/domus/h1/kevinfrs/private/Athaliana_flowersize/gwas/"),value = T)
...
for (t in 1:length(traits)) {
  cat(t)
gwas_flower<-read.table(paste0("/domus/h1/kevinfrs/private/Athaliana_flowersize/gwas/SNP_1001g_filtered_",traits[t],".assoc.txt"),h=T)
