...
head -n 1 /crex/proj/snic2020-16-182/A_thaliana/temp/temp/ancestry447/Genome_wide_iHS.txt > snp_lists/$filename.iHS.AD.txt

while read rs chr ps
do
grep $rs /crex/proj/snic2020-16-182/A_thaliana/temp/temp/ancestry447/Genome_wide_iHS.txt >> snp_lists/$filename.iHS.AD.txt
