...
#args<-c("flct_Hits_flowering_time","$PATH-TO-SERVER/A_thaliana/GWAs/Petal_Size_Ath/annotations/")
...
ihs<-read.table(file = paste0("$PATH-TO-SERVER/A_thaliana/temp/temp/snp_lists/",args[1],".iHS.AD.txt"),h=T )
